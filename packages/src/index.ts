...
*/
import Gukki_FormPuls from './FormPlus/main.vue'

Gukki_FormPuls.install = (app: any) => {
  app.component(Gukki_FormPuls.name, Gukki_FormPuls)
}

//默认导出
export default Gukki_FormPuls
